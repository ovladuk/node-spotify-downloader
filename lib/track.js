...
(function() {
  var Logger, Path, Track, domain, fs, httpRequest, id3, mkdirp,
  ...
  Track = (function() {
    ...
    Track.prototype.downloadCover = function() {
      ...
      return httpRequest.download(coverUrl, coverPath, (function(_this) {
        return function(err, progress) {
          if (err) {
        ...
        return function(err, response) {
          ...
          return Logger.Log("Cover downloaded: " + _this.track.artist[0].name + " - " + _this.track.name);
        };
      })(this));
    };
