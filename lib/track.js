...
(function() {
  var Logger, Path, Track, clone, deepMap, domain, fs, id3, mkdirp, objTypeof, ref, sformat,
  ...
  ref = require("./util"), objTypeof = ref.objTypeof, deepMap = ref.deepMap;
  ...
  Track = (function() {
    ...
    Track.prototype.fixPathPiece = function(piece) {
    ...
    Track.prototype.createDirs = function() {
      var _path, fields, fixStrg, pathFormat, stats, trackCopy;
      this.config.directory = Path.resolve(this.config.directory);
      pathFormat = this.config.format || "{artist.name} - {track.name}";
