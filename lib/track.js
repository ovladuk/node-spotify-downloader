...
(function() {
  ...
  Track = (function() {
    ...
    Track.prototype.downloadCover = function() {
      var coverPath, coverUrl, image, images, ref1;
      coverPath = this.file.path + ".jpg";
      images = this.track.album.coverGroup.image;
      image = (ref1 = images[2]) != null ? ref1 : images[0];
      if (!image) {
        Logger.Error("Can't download cover: " + this.track.artist[0].name + " - " + this.track.name);
        return;
      }
      coverUrl = "" + image.uri;
