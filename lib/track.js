...
(function() {
  ...
  Track = (function() {
    ...
    function Track(uri, index, config, data, callback) {
      this.uri = uri;
      this.index = index;
      this.config = config;
      this.data = data;
    ...
    Track.prototype.createDirs = function() {
      ...
      if (fields.track.number) {
        fields.track.number = padDigits(fields.track.number, String(this.data.trackCount).length);
      }
      if (this.data.type === "playlist" || this.data.type === "library") {
        fields.track.index = padDigits(this.index, String(this.data.trackCount).length);
