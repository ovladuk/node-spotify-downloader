...
(function() {
  var Logger, Path, Track, clone, deepMap, domain, fixPathPiece, fs, getSpotID, id3, mkdirp, objTypeof, ref, request, sformat,
  ...
  Track = (function() {
    ...
    function Track(uri, config, data, callback) {
      this.uri = uri;
      this.config = config;
      this.data = data;
    ...
    Track.prototype.process = function(uri, config, data, callback) {
      this.uri = uri;
      this.config = config;
      this.data = data;
      this.callback = callback;
