...
(function() {
  var Logger, Path, Track, async, clone, deepMap, domain, fixPathPiece, fs, id3, mkdirp, objTypeof, process, ref, request, sformat,
  ...
  Track = (function() {
    ...
    Track.init = function() {
      return process.on("SIGINT", function() {
        var ref1, ref2;
        Logger.Log("\nCLOSING [SIGINT]");
        return async.series([(ref1 = Track.cur) != null ? ref1.closeStream : void 0, (ref2 = Track.cur) != null ? ref2.cleanDirs : void 0], function(err) {
          if (err) {
